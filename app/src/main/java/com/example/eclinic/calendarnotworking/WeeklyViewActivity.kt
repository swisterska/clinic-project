...
//        }
//
//        slotsRef.whereEqualTo("date", date.toString())
//            .get()
//            .addOnSuccessListener { result ->
//                val existingSlots = result.documents.associateBy { it.getString("time") }
//
//// Check if there are any slots for this day
//                if (existingSlots.isEmpty()) {
//                    // No slots created yet for this day
//                    if (userRole == "DOCTOR") {
//                        addSlotBtn.visibility = View.VISIBLE
//                        selectedSlotsText.text = "No available slots."
...
//                    // Slots exist
//                    if (userRole == "DOCTOR") {
//                        addSlotBtn.visibility = View.VISIBLE // Or GONE if you want to hide when already defined
//                        selectedSlotsText.visibility = View.VISIBLE
...
//                val doctorId = intent.getStringExtra("id") ?: return@setPositiveButton
//                val db = Firebase.firestore
//                val batch = db.batch()
//
//                selectedItems.forEach { index ->
//                    val slotTime = allSlots[index]
//                    val slotId = "${date}_$slotTime".replace(":", "-")  // e.g., "2025-06-05_08:00"
